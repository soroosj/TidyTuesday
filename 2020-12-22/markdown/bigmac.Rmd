...
```{r}
   ...
   ggplot (big_mac_nok, aes(x=date)) +
      ...
      annotate(
         geom="text", x= as.Date("2003-01-30", "%Y-%m-%d"), y=0.6, 
         label = "Actual FX rate", color="white", size=3, hjust=0.5, vjust=0, fontface="bold", angle = 300
         ) +
      dark_theme_classic () +
         theme(
