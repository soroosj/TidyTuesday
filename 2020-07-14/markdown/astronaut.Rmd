...
```{r visualize}
   ...
   astronaut_plot <-
      ggplot (astronaut) +
         ...
         # annotate("text",
         #    label = "Astronaut sequential number for country / overall",
         #    size = 3, hjust = 0, color = "green", x = 0.7, y = 0.2
         #    ) +
         # # geom_curve(
         ...
         theme_void() +
         theme (
            plot.title = element_text (color = "white", margin = margin(0,0,20,0), hjust = 0.5, size = 22),
            plot.caption = element_text (color = "white", margin = margin(15,0,3,0), hjust = 1, size = 14),
      ...
      ggbackground (astronaut_plot, space_img, alpha = 0.2)
