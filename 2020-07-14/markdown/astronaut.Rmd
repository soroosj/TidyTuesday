...
```{r visualize}
   ...
   astronaut_plot <-
      ggplot (astronaut) +
         #add box header
            geom_rect(aes (xmin = 0, xmax = 1, ymin = 0, ymax = 1, fill = mission_title, color = mission_title), size = 3) +
         #add astronaut name
            geom_text(aes (x = 0.5, y = 0.97, label = name_clean), size = 3, hjust = 0.5, color = "white") +
         #add country flag
            geom_flag(aes (x = 0.09, y = 0.8, image = nationality_code), size = 0.17, hjust = 0.5) +
         #add astronaut years of life
            geom_text(aes (x = 0.5, y = 0.85, label = birth_death), size = 3, hjust = 0.5, vjust = 1, color = "white") +
         #add astronaut photo
            geom_image(aes(x=0.5, y=0.4, image = photo), size = 0.5) +
