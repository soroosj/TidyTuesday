...
```{r transform}
   ...
   astronaut <- astronaut_raw %>%
      ...
      select (name, nationality_name, nationality_code, birth_death, global_number, nationwide_number, mission_title, occupation, missions_count, missions_hours, photo) 
```
