...
```{r visualize_med}
   ...
   g <- ggplot (astronaut) +
      ...
      #add astronaut name / years of life
         geom_text(aes (x = 0.5, y = 0.9, label = name_life), size = 3, hjust = 0.5, vjust = 0.5, color = "white") +
      #add astronaut photo
         geom_image(aes(x=0.5, y=0.5, image = photo), size = 0.32) +
      #add country flag
         geom_flag(aes (x = 0.5, y = 0, image = nationality_code), size = 0.2, hjust = 0.5, vjust = 0) +
