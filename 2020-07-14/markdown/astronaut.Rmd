...
```{r visualize}
   ...
   astronaut_plot <-
      ggplot (astronaut) +
         ...
         #add astronaut photo
            geom_image(aes(x=0.5, y=0.4, image = photo), size = 0.45) +
         #add astronaut sequence number
            geom_text(aes (x = 0, y = 0, label = number_global_nation), size = 5, hjust = 0, vjust = 0, color = "white") +
         #add number of missions
            geom_text (aes (x = 1, y = 0, label = mission_hours_count), size = 5, hjust = 1, vjust = 0, color = "white") +
         ...
         theme_void() +
         theme (
            plot.title = element_text (color = "white", margin = margin(0,0,30,0), hjust = 0.5, size = 22),
            plot.caption = element_text (color = "white", margin = margin(22,0,3,0), hjust = 1, size = 14),
            strip.background = element_blank(),
            strip.text = element_blank(),
            legend.title = element_text(color = "white", hjust = 1, size = 13),
            legend.text = element_text(color = "white", hjust = 0, size = 13),
   ...
   ggdraw(astronaut_plot_2) + 
      draw_label("Astronaut number: country/global", x = .73, y = .18, color = "white") +
      draw_line(x = c(0.76, 0.76), y = c(0.24, 0.28), color = "white") +
      draw_label("Number of missions / total mission hours", x = .85, y = .23, color = "white") +
      draw_line(x = c(0.64, 0.64), y = c(0.19, 0.28), color = "white")
