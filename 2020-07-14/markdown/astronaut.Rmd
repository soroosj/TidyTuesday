...
```{r transform}
   ...
   astronaut <- astronaut_raw %>%
      ...
      select (name, nationality, birth_death, global_number, nationwide_number, mission_title, occupation, missions_count, missions_hours) 
```
