...
```{r transform, warning = TRUE, results = FALSE, message = FALSE}
   ...
   plot_median <-
      ggplot (coffee_summ, aes (x = 1, y = reorder(country_of_origin, rating_med))) +
         ...
         theme (
            plot.background = element_rect(fill= "#6F4E37", color = "white"),
   ...
   plot_grade <- 
      ggplot (coffee_grades, aes (x = grade_type, y = reorder(country_of_origin, grade_med))) +
         ...
         theme (
            ...
            panel.grid.major = element_blank(),
            panel.grid.minor = element_blank(),
            axis.text.x = element_text (size = 8, hjust = 0.5, vjust = 0.5, color = "white", angle = 80, margin = margin (0,0,0,0)),
   ...
   plot_distrib <-
      ggplot (coffee, aes (x = total_cup_points, y = reorder(country_of_origin, total_cup_points))) +
         ...
         theme (
            ...
            panel.grid.major = element_blank(),
            panel.grid.minor = element_blank(),
            axis.title = element_text (size = 9, hjust = 0.5, color = "white"),
            axis.text.x = element_text (color = "white", size = 8),
            axis.text.y = element_blank (),
            axis.ticks.x = element_line (color = "white"),
            axis.ticks.y = element_blank(),
...
```{r transform, warning = TRUE, results = FALSE, message = FALSE}
   ...
   plot_annotation (
      ...
      theme = theme (
         ...
         plot.title = element_text(hjust = 0.5, vjust = 0.5, size = 14, face = "bold", margin = margin (0,0,10,0), color = "white"),
