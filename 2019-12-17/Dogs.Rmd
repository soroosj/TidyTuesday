...
```{r visualize, message = F, warning = T}
   ...
   ggplot(data = dog_travel_flow, aes(axis1 = prior_region, axis2 = current_region, y = n)) +
      ...
      theme (
         ...
         plot.subtitle = element_text(hjust = 0.5, vjust = 0, size = 6, margin = margin (0,0,5,0)),
         plot.caption = element_text(hjust = 0, size = 6, face = "plain", margin = margin (10,0,0,0)),
         plot.caption.position = "plot",
         axis.title.y = element_text(margin = margin(0,10,0,0)),
         axis.text.x=element_blank(),
         axis.text.y=element_text(family = "Gaegu", size = 10),
      ...
      ggsave("dogs.png", width = 13, height = 8, units = "cm")
```