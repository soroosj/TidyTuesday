...
```{r}
   ...
   crops_mean <- crops %>%
      ...
      select(country, rank, mean, plot_image, d_1960s,d_1970s,d_1980s,d_1990s,d_2000s,d_2010s) %>%
      head (20) %>%
   ...
   crops_mean %>%
      ...
      gt () %>%
         ...
         text_transform(
            ...
            fn = function(x) {map(crops_mean$plot_code, ggplot_image, height = 23, aspect_ratio = 2.5)}
            ) %>%
        ...
        cols_label(rank = "Rank", country = "Country", d_1960s = "1960s", d_1970s = "1970s", d_1980s = "1980s", d_1990s = "1990s", d_2000s = "2000s", d_2010s = "2010s", mean = "Avg", plot_image = "By Year") %>%
