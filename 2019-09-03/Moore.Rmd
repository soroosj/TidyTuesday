   ...
   ggplot () +
      ...
      #Outperform annotations
         annotate(
            ...
            color="#6D7C83", size=3, hjust=0,vjust=0.5, fontface="bold", angle = 30
            ) +
      #Underperform annotations
         annotate(
            ...
            color="#6D7C83", size=3, hjust=0,vjust=0.5, fontface="bold", angle = 35
            ) +
      #scales
         scale_y_continuous(
            trans = log10_trans(),
      ...
      #themes
         dark_theme_classic () +
         theme(
            plot.title = element_text(hjust = 1.2, vjust = 0, size = 11.1, face = "bold", margin = margin (0,0,30,0)),
            plot.subtitle = element_text(hjust = 0.5, vjust = 0, size = 9, face = "bold", margin = margin (0,0,30,0)),
            plot.caption = element_text (hjust = 1, size = 7, face = "plain", margin = margin (20,0,0,0)),
            panel.grid.major = element_line(colour="white", size=0.023),
      ...
      ggsave("moore.png", width = 18.5, height = 14, units = "cm")
```
