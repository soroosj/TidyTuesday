...
```{r visualize, warning = TRUE, results = FALSE, message = FALSE}
   ...
   tour_map <- ggmap(
      ...
      theme(
         plot.title = element_text(hjust = 0.5, vjust = 0, size = 27, face = "bold", margin = margin (0,0,4,0)),
         plot.subtitle = element_text(hjust = 0.5, vjust = 0, size = 15, margin = margin (0,0,25,0)),
      ...
      labs(
         ...
         subtitle = "Stage numbers denoted in blue, stage winners listed in red.",
