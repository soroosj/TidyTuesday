...
```{r visualize, warning = TRUE, results = FALSE, message = FALSE}
   ...
   tour_map <- ggmap(
      ...
      geom_text_repel (
         ...
         color = "red", size = 4, alpha = 0.9, fontface = "plain", segment.size = 1
         ) +
      geom_text (
         data = winners,
         aes (label = name_full, group = year),
         color = "blue", size = 4.5, x = 4, y = 54.45
         )+
      geom_text (
         data = winners,
         aes (label = time_overall, group = year),
         color = "blue", size = 4.5, x = 4, y = 54.15
         )+
      geom_text (
         data = winners,
         aes (label = time_margin, group = year),
         color = "blue", size = 4.5, x = 4, y = 53.85
         )+
      geom_text (
         data = winners,
         aes (label = stage_wins, group = year),
         color = "blue", size = 4.5, x = 4, y = 53.55
         )+
