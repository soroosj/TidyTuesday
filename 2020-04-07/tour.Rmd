...
```{r visualize, warning = TRUE, results = FALSE, message = FALSE}
   ...
   tour_map <- ggmap(
      ...
      geom_segment(
         data = stages_full,
         aes (x = origin_lon, xend = origin_lon,
              y = origin_lat, yend = origin_lat,
              group = year),
         color = "black", size = 2,
      ...
      geom_text (
         data = stages_full,
         aes (x = destination_lon, y = destination_lat, label = stage, group = year),
         color = "black", size = 4, alpha = 0.7
         ) +
      geom_text (
         data = winners,
         aes (label = name_full, group = year),
         color = "black", size = 4, x = 4, y = 54.85
         )+
      geom_text (
         data = winners,
         aes (label = time_overall, group = year),
         color = "black", size = 4, x = 4, y = 54.5
         )+
      geom_text (
         data = winners,
         aes (label = time_margin, group = year),
         color = "black", size = 4, x = 4, y = 54.15
         )+
      geom_text (
         data = winners,
         aes (label = stage_wins, group = year),
         color = "black", size = 4, x = 4, y = 53.80
         )+
