...
```{r visualize}
   ...
   tour_map <- ggmap(
      ...
      labs(
         title = "Tour De France Summary - {closest_state}",
         caption = "Visualization: Joel Soroos @soroosj  |  Data: Wikipedia"
         )

      animate(tour_map, renderer = gifski_renderer())
      
      #https://duvancho321.github.io/Tidyuesday/Folder/2020/2020-01-07/
```
