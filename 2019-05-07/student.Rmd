...
continent_plot <- student %>%
   ...
   #scale_x_discrete(limits = rev(levels(continent))) +
   labs(
      title = "Student/Teacher Ratio for Upper Secondary Schools by Continent (2016)",
      caption = "Source:UNESCO Institute of Statistics  |  R4DS Tidy Tuesday
      Visualization: Joel Soroos @soroosj",
      x = "",
      y = "") 

ggsave ("continent.png", continent_plot)
...
### 4b. Create ridgeline chart by continent
```{r plot2}
...
indicator_plot <- student %>%
   ...
   geom_density_ridges (fill = "blue") +
   labs(
      title = "Student/Teacher Ratio by Education Level in Europe (2016)",
      caption = "Source:UNESCO Institute of Statistics  |  R4DS Tidy Tuesday
      Visualization: Joel Soroos @soroosj",
      x = "",
      y = "")

ggsave ("indicator.png", indicator_plot)
